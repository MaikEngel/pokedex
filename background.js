...
function loadPokemonBackground(i, type) {
...
/*
#################################################################################
Background-color in searchbar
#################################################################################
*/

function renderSearchBackground(i, type) {
    let backgroundColor = document.getElementById('pokemonSearch' + i)
    let firstType = type;
...
/*
#################################################################################
Background-color in fullscreen view
#################################################################################
*/

function loadDetailBackground(i, type) {
